    ...
    return (
      <React.Fragment>
        ...
        <div className="text-center p-3">
          ...
          <h4>
            1 {baseAcronym} = {rate.toFixed(4)} {currencies[quoteAcronym].name}
          </h4>
        </div>

        <form className="form-row d-flex p-3 mb-4 justify-content-center">
          <div className="form-group col-3 mb-0">
            ...
            <div className="input-group">
              <div className="input-group-prepend">
                <div className="input-group-text" style={{height:50}}>
